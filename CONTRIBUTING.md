...
The Fantasy Statblocks Code of Conduct [governs these project and everyone participating in it](https://github.com/javalent/dice-roller/CODE_OF_CONDUCT.md).
By participating, you're expected to, and agreeing to, uphold this code.


## I've a Question

> If you want to ask a question, we assume that you've read the available [Documentation](https://plugins.javalent.com/Dice+Roller/Dice+Roller).

Before you ask a question,
it is best to search for existing [Issues](https://github.com/javalent/dice-roller/issues) that might help you. 
...
- Open an [Issue](https://github.com/javalent/dice-roller/issues/).
...
- Determine if your bug is really a bug and not an error on your side, for example, using incompatible environment components/versions or have plugin interactions (Make sure that you've read the [documentation](https://plugins.javalent.com/dice-roller). If you're looking for support, you might want to check [this section](CONTRIBUTING.md#ive-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you're having, check if there isn't already a bug report existing for your bug or error in the [bug tracker](https://github.com/javalent/dice-roller/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/javalent/dice-roller/issues/new) and select the Bug Template.
...
- Perform a [search](https://github.com/javalent/dice-roller/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
- Consider posting in the [Ideas section](https://github.com/javalent/dice-roller/discussions/categories/ideas) of the Discussion Forum for communal vetting of your idea. 
...
Feature suggestions are tracked as [GitHub issues](https://github.com/javalent/dice-roller/issues).
...
Create a Github Issue in the appropriate documentation repository stating what you think should change. If you're creating an Issue on how you would like to contribute, please include two sample paragraphs of your writing.
